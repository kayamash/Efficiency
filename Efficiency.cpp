     ...
     Int_t numSP = 0;
          ...
          switch(EtaDistribution(pSA_roieta)){
               ...
               if(numSP == 0){
                    ...
                    if(dividePhi >= 0)m_h_eL1PtBarrel0SPRoIPhiDivide[(Int_t)dividePhi]->Fill(std::fabs(m_poff_pt*0.001));
                    ...
                    */
                    ...
                    switch(EtaDistribution(pSA_roieta)){
                         ...
                         if(numSP == 0){
                              ...
                              if(dividePhi >= 0)m_h_eSAPtBarrel0SPRoIPhiDivide[(Int_t)dividePhi]->Fill(std::fabs(m_poff_pt*0.001));
                         }
