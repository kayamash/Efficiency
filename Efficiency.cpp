...
void Efficiency::MatchSegmentBI(Double_t (&segx)[10],Double_t (&segy)[10],Double_t (&etaindex)[10],TH1D *h1,TH2F *h2,TH1D *h3,TH1D *h4,TH2F *h5,Double_t SPR_BI,Double_t (&segpar)[4]){
     for(Int_t i = 0;i < 4;i++){
          segpar[i] = 0;
     }
     segpar[0] = 99999;
     ...
     for(Int_t index = 0;index < 10;index++){
          if(sqrt(pow(segx[index],2) + pow(segy[index],2)) > 4600 && sqrt(pow(segx[index],2) + pow(segy[index],2)) < 6500){
               ...
               if(diffR > sqrt(pow(segx[index],2) + pow(segy[index],2))){
                    if(segpar[0] != 99999){
                         h1->Fill(segpar[0] - SPR_BI);
                         h2->Fill(segpar[2],segpar[3]);
                    }
                    segpar[0] = sqrt(pow(segx[index],2) + pow(segy[index],2));
     ...
     for(Int_t i = 0;i < m_nhist;i++){
          ...
          switch(static_cast<Int_t>(pSA_sAddress)){//switch Large ,LS , Small ,SS
               ...
               case 1:
                    ...
                    if(segment_parameter[1] != 0){
                         Int_t buf_index = fabs(static_cast<Int_t>(segment_parameter[1]));
                         switch(buf_index){
                              case 1:
                                   m_h_segSP_diffR_LSBIetaindex1.at(i)->Fill(segment_parameter[0] - pSA_superpointR_BI);
                                   break;
                              case 2:
                                   m_h_segSP_diffR_LSBIetaindex2.at(i)->Fill(segment_parameter[0] - pSA_superpointR_BI);
                                   break;
                              case 3:
                                   m_h_segSP_diffR_LSBIetaindex3.at(i)->Fill(segment_parameter[0] - pSA_superpointR_BI);
                                   break;
                              case 4:
                                   m_h_segSP_diffR_LSBIetaindex4.at(i)->Fill(segment_parameter[0] - pSA_superpointR_BI);
                                   break;
                              case 5:
                                   m_h_segSP_diffR_LSBIetaindex5.at(i)->Fill(segment_parameter[0] - pSA_superpointR_BI);
                                   break;
                              case 6:
                                   m_h_segSP_diffR_LSBIetaindex6.at(i)->Fill(segment_parameter[0] - pSA_superpointR_BI);
                                   break;
                              default :
                                   break;
                         }
...
void Efficiency::Finalize(TFile *tf1){
     ...
     for(Int_t i = m_thmin;i < m_nhist*m_thpitch;i += m_thpitch){
          //base,target
          ...
          ceff.SetConditionName(Form("SAEfficiency_%dGeV",i));
          ...
          ceff.SetConditionName(Form("CBEfficiency_%dGeV",i));
          ...
          ceff.SetConditionName(Form("EFEfficiency_%dGeV",i));
          ...
          ceff.SetConditionName(Form("L1Efficiency_eta_%dGeV",i));
          ...
          ceff.SetConditionName(Form("SAEfficiency_eta_%dGeV",i));
          ...
          ceff.SetConditionName(Form("CBEfficiency_eta_%dGeV",i));
          ...
          ceff.SetConditionName(Form("EFEfficiency_eta_%dGeV",i));
          ...
          ceff.SetConditionName(Form("L1Efficiency_phi_%dGeV",i));
          ...
          ceff.SetConditionName(Form("SAEfficiency_phi_%dGeV",i));
          ...
          ceff.SetConditionName(Form("CBEfficiency_phi_%dGeV",i));
          ...
          ceff.SetConditionName(Form("EFEfficiency_phi_%dGeV",i));
          ...
          ceff.SetConditionName(Form("L1Efficiency_pileup_%dGeV",i));
          ...
          ceff.SetConditionName(Form("SAEfficiency_pileup_%dGeV",i));
          ...
          ceff.SetConditionName(Form("CBEfficiency_pileup_%dGeV",i));
          ...
          ceff.SetConditionName(Form("EFEfficiency_pileup_%dGeV",i));
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeplus_%dGeV",i));
          ...
          ceff.SetConditionName(Form("L1EfficiencyLargeSpecialplus_%dGeV",i));
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialplus_%dGeV",i));
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialplus15_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ceff.DrawEfficiency(m_h_eL1_pt_LargeSpecialplus15.at(i),m_h_eSA_pt_LargeSpecialplus15.at(i),m_binmax,300,m_efficiency_xerr);
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialminus15_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialplus11out_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialminus11out_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialplus15out_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialminus15out_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialplus11in_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialminus11in_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialplus15in_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("SAEfficiencyLargeSpecialminus15in_%dGeV",i));
          ceff.SetCondition("SA LargeSpecial Efficiency;offline pt[GeV];Efficiency",1.0,0.1,0.1,0.105,0.165);
          ...
          ceff.SetConditionName(Form("L1EfficiencySmallplus_%dGeV",i));
          ...
          ceff.SetConditionName(Form("SAEfficiencySmallplus_%dGeV",i));
          ...
          ceff.SetConditionName(Form("SAEfficiencySmallSpecialplus_%dGeV",i));
          ...
          ceff.SetConditionName(Form("L12DEfficiency_%dGeV",i));
          ...
          m_g_rpchitXY.at(i)->SetName(Form("g_rpchitxy_%dGeV",i));
          m_g_mdthitXY.at(i)->SetName(Form("g_mdthitxy_%dGeV",i));
          ...
          m_h_segSP_diffRmatch_LargeBI.at(i)->Write();
          m_h_segSP_diffR_LSBIetaindex1.at(i)->Write();
          m_h_segSP_diffR_LSBIetaindex2.at(i)->Write();
          m_h_segSP_diffR_LSBIetaindex3.at(i)->Write();
          m_h_segSP_diffR_LSBIetaindex4.at(i)->Write();
